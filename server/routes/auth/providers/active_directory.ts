...
const ACTIVE_DIRECTORY_BIND_CREDENTIALS = process.env.ACTIVE_DIRECTORY_BIND_CREDENTIALS;
const ACTIVE_DIRECTORY_SEARCH_BASE = process.env.ACTIVE_DIRECTORY_SEARCH_BASE;
const ACTIVE_DIRECTORY_SEARCH_FILTER = process.env.ACTIVE_DIRECTORY_SEARCH_FILTER;
const ACTIVE_DIRECTORY_SEARCH_ATTRIBUTES = process.env.ACTIVE_DIRECTORY_SEARCH_ATTRIBUTES;
    ...
    new LdapStrategy(
      ...
      async function (req, profile, done) {
        try {
          ...
          if (!profile) {
            throw LdapError(
              "Unable to load user profile from LDAP"
            );
          }
